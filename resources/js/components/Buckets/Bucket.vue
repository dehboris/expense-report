  ...
  <div class="max-w-5xl mx-auto sm:px-4">
    <div class="md:mb-10">
      ...
      <div class="flex">
        ...
        <router-link class="font-bold bg-yellow-600 text-gray-100 rounded px-2 transition-fast hover:bg-yellow-700 mr-3" to="#">Edit</router-link>
    ...
    <div class="flex flex-wrap justify-center p-4 sm:shadow-lg sm:p-10">
      <div role="form" class="w-full flex flex-wrap border-b-2 border-gray-400 pb-6 mb-3">
        <div class="w-full mb-3 md:w-5/12 md:px-3 md:mb-0">
          ...
          <input type="text" id="name" class="input" placeholder="Jerseys">
        ...
        <div class="w-full mb-6 md:w-2/12 md:px-3 md:mb-0 xl:w-3/12">
          ...
          <input type="text" id="amount" class="input" placeholder="245.99">
      ...
      fetchData(id) {
        ...
        axios.all(this.fetchBucket(id), this.fetchBucketItems(id))
          .then(axios.spread((bucket, items) => {
            ...
            // this.bucket = {...this.bucket, bucket, items};
